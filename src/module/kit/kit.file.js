...
@observer
export default class KtFIle extends Component {
  ...
  useFile(item) {
    EXT_WHITEBOARD.clearFile()// 先关掉文件 ，然后再加载新的文件
    StoreWhiteBoard.setCurrentFile(item.docId);
    StoreWhiteBoard.setFileKitEnable(false);
    EXT_WHITEBOARD.setFileObj(item);
  ...
  render() {
    console.log('render kit.file', WhiteBoardState.fileKitEnable);
    console.log('render kit.file', this.props);
    return (
