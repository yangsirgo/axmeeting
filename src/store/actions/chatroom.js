...
export default class {
  ...
  state = {
    ...
    isShowMemberTab: true, //是否在成员列表tab
  ...
  @action
  mergeCustom(custom){
    // ['showType','shareID','fullScreenType'].forEach(key=>{
    //   if(key in custom){
    //     this.state.custom[key] = custom[key];
    //   }
    // })
    Object.assign(this.state.custom  , custom)
    console.log('store --> chatroom --> state',  this.state.custom)
    console.log('store --> chatroom --> mergeCustom', custom)
  }
  @action
  setCustom(custom){
